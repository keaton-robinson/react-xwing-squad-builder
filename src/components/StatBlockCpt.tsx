...
export default class StatBlockCpt extends React.Component<{pilot, ship, upgrade, pilotAfterUpgrades}> {
    ...
    renderEffectiveStat = (baseStat, statAfterUpgrades) => {
        return (
            <span>{baseStat ? baseStat : 0} { statAfterUpgrades && statAfterUpgrades != baseStat ? `(${statAfterUpgrades})` : null}</span>
        );
    }
            ...
            <table className="info-stats">
                <tbody>
                    { (shipOrUpgrade.attack || shipAfterUpgrades?.attack) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attack, shipAfterUpgrades?.attack)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackf || shipAfterUpgrades?.attackf) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackf, shipAfterUpgrades?.attackf)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackb || shipAfterUpgrades?.attackb) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackb, shipAfterUpgrades?.attackb)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackl || shipAfterUpgrades?.attackl) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackl, shipAfterUpgrades?.attackl)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackr || shipAfterUpgrades?.attackr) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackr, shipAfterUpgrades?.attackr)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackt || shipAfterUpgrades?.attackt) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackt, shipAfterUpgrades?.attackt)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackdt || shipAfterUpgrades?.attackdt) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackdt, shipAfterUpgrades?.attackdt)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.attackbull || shipAfterUpgrades?.attackbull) ? 
                        ...
                        <td className="info-attack">{this.renderEffectiveStat(shipOrUpgrade.attackbull, shipAfterUpgrades?.attackbull)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.agility || shipAfterUpgrades?.agility) ?  
                        <tr className="stat-icon">
                            ...
                            <td className="info-agility">{this.renderEffectiveStat(shipOrUpgrade.agility, shipAfterUpgrades?.agility)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.hull || shipAfterUpgrades?.hull) ? 
                        <tr className="stat-icon">
                            ...
                            <td className="info-hull">{this.renderEffectiveStat(shipOrUpgrade.hull, shipAfterUpgrades?.hull)}</td>
                        </tr>
                    : null }
                    { (shipOrUpgrade.shields || shipAfterUpgrades?.shields) ? 
                        ...
                        <td className="info-shield">{this.renderEffectiveStat(shipOrUpgrade.shields, shipAfterUpgrades?.shields)}</td>
                        </tr> 
                    : null }
                    { ((pilot?.force || shipOrUpgrade.force) || (pilotAfterUpgrades?.force + shipAfterUpgrades?.force))? 
                        ...
                        <td className="info-force">{this.renderEffectiveStat(pilot?.force || shipOrUpgrade.force, pilotAfterUpgrades?.force + shipAfterUpgrades?.force)}</td>
                        </tr>
                    : null }
                    { (pilot?.charge || shipOrUpgrade.charge) ? 
                        <tr className="stat-icon">
                        <td><i className="xwing-miniatures-font header-charge xwing-miniatures-font-charge"></i></td>
                        <td className="info-charge">{this.renderEffectiveStat(pilot?.charge || shipOrUpgrade.charge, null)}</td>
                        </tr>
                    : null } 
                </tbody>
            </table>
