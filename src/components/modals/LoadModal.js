        ...
        return (
            <div>
                ...
                <div style={{ textAlign: "right"}}>
                    <button className={`btn-danger${!this.state.selectedSquad ? " fa-disabled" : ""}`} disabled={!this.state.selectedSquad} onClick={this.deleteClicked}><i className="fa-solid fa-times"></i> Delete</button>
