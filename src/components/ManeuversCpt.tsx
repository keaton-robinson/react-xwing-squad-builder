                ...
                speedRows.push(
                    <tr key={`speed${i}`}>
                        ...
                        { columnsToRender[0] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.left_hard} difficulty={getEffectiveManeuver(i, 0)} />
                        </td> : null
                        }
                        { columnsToRender[1] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.left_bank} difficulty={getEffectiveManeuver(i,1)} />
                        </td> : null }
                        { columnsToRender[2] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.straight} difficulty={getEffectiveManeuver(i,2)} />
                        </td> : null }
                        
                        { columnsToRender[3] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.right_bank} difficulty={getEffectiveManeuver(i,3)} />
                        </td> : null }
                        
                        { columnsToRender[4] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.right_hard} difficulty={getEffectiveManeuver(i,4)} />
                        </td> : null }

                        { columnsToRender[5] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.k_turn} difficulty={getEffectiveManeuver(i,5)} />
                        </td> : null }
                        
                        { columnsToRender[6] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.left_sloop} difficulty={getEffectiveManeuver(i,6)} />
                        </td> : null }
                        
                        { columnsToRender[7] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.right_sloop} difficulty={getEffectiveManeuver(i,7)} />
                        </td> : null }

                        { columnsToRender[8] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.left_tallion} difficulty={getEffectiveManeuver(i,8)} />
                        </td> : null }
                        
                        { columnsToRender[9] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.right_tallion} difficulty={getEffectiveManeuver(i,9)} />
                        </td> : null }
                        
                        { columnsToRender[10] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.reverse_left} difficulty={getEffectiveManeuver(i,10)} />
                        </td> : null }
                        
                        { columnsToRender[11] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.reverse_straight} difficulty={getEffectiveManeuver(i,11)} />
                        </td> : null }

                        { columnsToRender[12] ? <td>
                            <ManeuverCpt bearing={xwingData.bearings.reverse_right} difficulty={getEffectiveManeuver(i,12)} />
                        </td> : null }
                    </tr>
                );
            }
