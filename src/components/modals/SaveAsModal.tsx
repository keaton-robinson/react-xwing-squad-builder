...
const SaveAsModal:React.FC<SaveAsModalProps> = (props) =>  {
    ...
    return (
        <div>
            ...
            <span>Squad Name: <input type="text" value={state.squadName} onChange={squadNameChanged} maxLength={30}/></span>
            <hr/>
            <div style={{ textAlign: "right"}}>
                <button className="btn-primary" onClick={saveAsClicked}><i className="fa-solid fa-save"></i> Save</button>
            </div>
        </div>
    );
}
