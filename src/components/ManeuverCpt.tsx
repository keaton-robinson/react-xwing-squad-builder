...
const ManeuverCpt: React.FC<ManeuverCptProps> = (props) => {
  ...
  if (!props.difficulty) {
    //ship cannot perform this bearing at the current speed
    return null;
  }
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 200 200">
          <g className="maneuver ">
            <path
              ...
              fill="none"
              stroke="black"
              d="M100,180 L100,100 100,80"
            ></path>
            <path
              className="svg-maneuver-triangle svg-white-maneuver svg-base-maneuver"
              d="M70,80 H130 L100,30 Z"
              fill={getDifficultyUIColor()}
              strokeWidth="5"
              stroke="black"
            ></path>
            <path
              className="svg-maneuver-inner svg-white-maneuver svg-base-maneuver"
              strokeWidth="15"
              fill="none"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 200 200">
          <g className="maneuver ">
            <path
              ...
              fill="none"
              stroke="black"
              d="M50,180 S50,120 120,60"
            ></path>
            <path
              className="svg-maneuver-triangle svg-white-maneuver svg-base-maneuver"
              d="M120,100 V40 L170,70 Z"
              fill={getDifficultyUIColor()}
              strokeWidth="5"
              stroke="black"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 200 200">
          <g className="maneuver ">
            <path
              ...
              fill="none"
              stroke="black"
              d="M50,180 L50,100 C50,10 140,10 140,100 L140,120"
            ></path>
            <path
              className="svg-maneuver-triangle svg-red-maneuver svg-base-maneuver"
              d="M170,120 H110 L140,180 Z"
              fill={getDifficultyUIColor()}
              strokeWidth="5"
              stroke="black"
            ></path>
            <path
              className="svg-maneuver-inner svg-red-maneuver svg-base-maneuver"
              strokeWidth="15"
              fill="none"
              stroke={getDifficultyUIColor()}
              d="M50,180 L50,100 C50,10 140,10 140,100 L140,120"
      ...
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 200 200">
          <rect
            ...
            width="100"
            height="100"
            style={{ fill: "red", strokeWidth: 5, stroke: "black" }}
          ></rect>
        </svg>
      );
